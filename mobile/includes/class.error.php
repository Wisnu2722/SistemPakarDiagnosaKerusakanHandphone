    ...
    class Error
    {
        ...
        public function blank($val, $id, $name = null)
        {
            if(trim($val) == '')
            {
                ...
                $this->add($id, "$name tidak boleh kosong.");
                return false;
            }
        ...
        public function range($val, $lower, $upper, $id, $name = null)
        {
            ...
            {
                if(is_null($name)) $name = ucwords($id);
                $this->add($id, "$name harus diantara $lower dan $upper.");
                return false;
            }
        ...
        public function length($val, $lower, $upper, $id, $name = null)
        {
            ...
            {
                if(is_null($name)) $name = ucwords($id);
                $this->add($id, "$name paling sedikit $lower karakter.");
                return false;
            }
            elseif(strlen($val) > $upper)
            {
                if(is_null($name)) $name = ucwords($id);
                $this->add($id, "$name tidak boleh lebih dari $upper karakter.");
                return false;
            }
        ...
        public function passwords($pass1, $pass2, $id)
        {
            if($pass1 !== $pass2)
            {
                $this->add($id, 'Password tidak sama.');
                return false;
            }
        ...
        public function captchanya($sescapt, $postcapt1, $id)
        {
            if (empty($sescapt) || trim(strtolower($postcapt1)) != $sescapt)
            {
                $this->add($id, 'Kode Captcha salah.');
                return false;
            }
        ...
        public function date($val, $id)
        {
            ...
            {
                $this->add($id, 'tanggal tidak valid');
                return false;
            }
        ...
        public function adult($val, $id)
        {
            ...
            {
                $this->add($id, 'anda harus berumur 18 tahun atau lebih.');
                return false;
            }
        ...
        public function url($val, $id, $name = null)
        {
            ...
            {
                if(is_null($name)) $name = ucwords($id);
                $this->add($id, "$name URL tidak valid.");
                return false;
            }
            return true;
        }
